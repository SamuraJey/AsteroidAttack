...
pygame.display.set_caption("Аттака метеоров 0.1")
...
def show_go_screen():
    ...
    draw_text(screen, "Стрелочки - двигаться, пробел - стрелять", 22,
              WIDTH / 2, HEIGHT / 2)
...
meteor_images = []
meteor_list = ['meteorBrown_big1.png', 'meteorBrown_med3.png', 'meteorBrown_med3.png',
